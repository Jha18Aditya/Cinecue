const providerSearchUrls = {
  ...
  122: (title) => `https://www.jiohotstar.com/in/search?query=${encodeURIComponent(title)}`,
  9: (title) => `https://www.primevideo.com/search/ref=atv_nb_sr?phrase=${encodeURIComponent(title)}`,
  10: (title) => `https://www.primevideo.com/search/ref=atv_nb_sr?phrase=${encodeURIComponent(title)}`,
  119: (title) => `https://www.primevideo.com/search/ref=atv_nb_sr?phrase=${encodeURIComponent(title)}`,
  210: (title) => `https://www.primevideo.com/search/ref=atv_nb_sr?phrase=${encodeURIComponent(title)}`,
  220: (title) => `https://www.jiohotstar.com/in/search?query=${encodeURIComponent(title)}`,
  233: (title) => `https://www.jiohotstar.com/in/search?query=${encodeURIComponent(title)}`,
